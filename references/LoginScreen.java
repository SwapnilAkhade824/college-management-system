...
public class LoginScreen {
    ...
    public static void main(String[] args) {
        ...
        // ---------------- LEFT CONTENT ----------------
        RoundedPanel leftInnerPanel = panels.getRoundedPanel(
            new Color(0xC6C6C8),
            60
        );
        leftInnerPanel.setPreferredSize(new Dimension(450, 500));
        ...
        requestButton.setBounds(125, 400, 200, 60);
        ...
        designLabel.setBounds(70, 175, 300, 100);

        leftInnerPanel.add(requestButton);
        leftInnerPanel.add(designLabel);
        ...
        gbcLeft.weightx = 1;
        gbcLeft.weighty = 1;
        gbcLeft.insets = new Insets(25, 25, 25, 25);
        ...
        loginLabel.setFont(theme.getDerivedFont(32f).deriveFont(Font.BOLD));
        loginLabel.setBounds(125, 80, 200, 70);
        loginLabel.setHorizontalAlignment(SwingConstants.CENTER);

        JLabel userLabel = new JLabel("UserID:");
        userLabel.setFont(theme.getDerivedFont(24f).deriveFont(Font.BOLD));
        userLabel.setBounds(50, 180, 170, 60);

        JLabel passLabel = new JLabel("Password:");
        passLabel.setFont(theme.getDerivedFont(24f).deriveFont(Font.BOLD));
        passLabel.setBounds(10, 260, 235, 60);

        JTextField userField = new JTextField();
        userField.setFont(theme.getDerivedFont(24f).deriveFont(Font.PLAIN));
        userField.setBounds(180, 180, 250, 58);
        userField.setOpaque(false);
        userField.setBorder(new RoundedBorder(30, Color.BLACK, 2));

        JPasswordField passField = new JPasswordField();
        passField.setFont(theme.getDerivedFont(24f).deriveFont(Font.PLAIN));
        passField.setBounds(180, 260, 250, 58);
        ...
        loginButton.setBounds(125, 370, 200, 60);

        rightInnerPanel.add(messagePanel);
        rightInnerPanel.add(loginLabel);
        rightInnerPanel.add(userLabel);
        rightInnerPanel.add(passLabel);
        rightInnerPanel.add(userField);
        rightInnerPanel.add(passField);
